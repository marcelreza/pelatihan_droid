...
public class MainActivity extends AppCompatActivity {
    ...
    public void printReceipt(View view){
        ...
        barang[0] = ((EditText) findViewById(R.id.tv_num)).getText().toString();
        barang[1] = ((EditText) findViewById(R.id.kipas_num)).getText().toString();
        ...
        intent.putExtra("main.tv.num",num_barang[0]);
        intent.putExtra("main.kipas.num",num_barang[1]);
        intent.putExtra("main.vacum.num",num_barang[2]);
        intent.putExtra("main.ac.num",num_barang[3]);
        intent.putExtra("main.cctv.num",num_barang[4]);
